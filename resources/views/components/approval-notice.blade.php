...
<div class="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
    <div class="flex items-start">
        <svg class="w-5 h-5 text-blue-400 dark:text-blue-500 mr-2 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"/>
        </svg>
        <div>
            <p class="text-blue-700 dark:text-blue-300 font-medium mb-1">Sistema de Aprovação</p>
            <p class="text-blue-600 dark:text-blue-400 text-sm">
                Após o registro, sua conta precisará ser aprovada por um administrador antes que você possa acessar o sistema.
            </p>
        </div>
    </div>
</div>
